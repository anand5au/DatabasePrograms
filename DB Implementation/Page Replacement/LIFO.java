...
/**
 * A LIFO algorithm for buffer pool replacement policy. It picks up the frame in
 * the buffer pool to be replaced. This is the default replacement policy.
 */
public class LIFO extends Replacer
{
	...
	public void info()
	{
		...
		System.out.print("LIFO REPLACEMENT - Used frames");
