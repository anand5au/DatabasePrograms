...
public class LightningInequalitySelfJoinfinal extends Iterator implements GlobalConst {
	 ...
	 * @throws JoinsException 
	   */
	  public LightningInequalitySelfJoinfinal(AttrType    in1[],               
			   int     len_in1,                        
			   short   s1_sizes[],
			   AttrType    in2[],                
			   int     len_in2,                        
		...
		/*  	for(int i=0;i<L1.size();i++)
		  	{
		  		System.out.println(L1.get(i).getIntFld(3) + "  "+L1.get(i).getIntFld(4));
		  	}*/
