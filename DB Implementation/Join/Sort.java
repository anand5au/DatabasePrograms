...
public class Sort extends Iterator implements GlobalConst
{
  ...
  {
	  this._in = s._in;
	  this.n_cols = s.n_cols;
	  this.str_lens = s.str_lens;
	  this._am = s._am;
	  this._sort_fld = s._sort_fld;
	  this.order = s.order;
	  this._n_pages = s._n_pages;
	  this.bufs = s.bufs;
	  this.first_time = s.first_time;
	  this.Nruns = s.Nruns;
	  this.max_elems_in_heap = s.max_elems_in_heap;
	  this.sortFldLen = s.sortFldLen;
	  this.tuple_size = s.tuple_size;
	    
	  this.Q = s.Q;
	  this.temp_files = s.temp_files;
	  this.n_tempfiles = s.n_tempfiles;
	  this.output_tuple = s.output_tuple;
	  this.n_tuples = s.n_tuples;
	  this.n_runs = s.n_runs;
	  this.op_buf = s.op_buf;
	  this.o_buf = s.o_buf;
	  this.i_buf = s.i_buf;
	  this.bufs_pids = s.bufs_pids;
	  this.useBM = s.useBM;
  }
  /** 
